                ...
                <Row className="g-2">
                  <Col xs={12} className="mb-5">
                    <div className={formStyle.formGroup}>
                      <select
                        name=""
                        id=""
                        onChange={(e) => setTypeOfSecurity(e.target.value)}
                      >
                        <option value="">Type of Security</option>
                        <option value="common-equity">
                          Common Equity (CE)
                        </option>
                  ...
                  <Col xs={12}>
                    <div className={formStyle.formGroup}>
                      ...
                      <input
                        onChange={(e) => setTypeOfShareholder(e.target.value)}
                        type="email"
                        name=""
                        id=""
                      />
                ...
                <Row className="g-2">
                  ...
                  <Col xs={12}>
                    <div className={formStyle.formGroup}>
                      ...
                      >
                        <option value="1,000" className="d-flex">
                          $1,000.00 USDT
                        </option>
                        <option value="3,000" className="d-flex">
                          $2,000.00 USDT
                        </option>
                        <option value="5,000" className="d-flex">
                          $5,000.00 USDT
                        </option>
                      </select>
                    </div>
                ...
                <Col md={12} lg={12} xl={12}>
                  <Row className="gy-4">
                    ...
                    <Col xs={12}>
                      <Row>
                        <Col xs={12} sm={4} md={3}>
                          <div className={formStyle.doubleDataPicker}>
                            <span>
                              <FeatherIcon icon="calendar" size={18} />
                            </span>
                            <div className={formStyle.dateInput}>
